...
public class Trips {
    ...
    public Trips(String tripID, String tripStartPoint, double tripStartPointLongitude, double tripStartPointLatitude, String tripEndPoint, double tripEndPointLongitude, double tripEndPointLatitude, String tripName, String tripDate, String tripTime, String tripStatus, String userID, long tripCalendar) {
        this.tripID = tripID;
